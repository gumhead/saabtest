...
import {listg} from '../../../src/components/dictionarylist/listg';
...
const G: NextPage = () => {
    return (
        <DictionaryLayout pageTitle="Uppslagsverket" description="G">
            {/* ========== section 1 ========== */}
                ...
                <div className="dictionary-entry">
                    <div className="grid grid-view">
                        <div className="row gx-md-8 gy-10 gy-md-13 isotope">
                            {listg.map(({ name, id, entrytext_synonym, entrytext_subheadline, entrytext_main, relatedlinks }) => (
